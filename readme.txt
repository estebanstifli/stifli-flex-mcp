...
== Changelog ==
= 3.4.8 =
* Fix: Restored legacy SSE response delivery so Claude Desktop connectors receive `initialize` and other JSON-RPC responses through their active SSE session.
