...
class StifliFlexMcp_WC_System {
    ...
    public static function getCapabilities() {
        return array(
            'wc_get_sales_report' => 'view_woocommerce_reports',
            'wc_get_top_sellers_report' => 'view_woocommerce_reports',
            'wc_get_tax_classes' => 'manage_woocommerce',
            'wc_get_tax_rates' => 'manage_woocommerce',
            'wc_create_tax_rate' => 'manage_woocommerce',
            'wc_update_tax_rate' => 'manage_woocommerce',
            'wc_delete_tax_rate' => 'manage_woocommerce',
            'wc_get_shipping_zones' => 'manage_woocommerce',
            'wc_get_shipping_zone_methods' => 'manage_woocommerce',
            ...
            'wc_get_payment_gateways' => 'manage_woocommerce',
            'wc_update_payment_gateway' => 'manage_woocommerce',
            'wc_get_system_status' => 'manage_woocommerce',
            'wc_run_system_status_tool' => 'manage_woocommerce',
            'wc_get_settings' => 'manage_woocommerce',
            'wc_update_setting_option' => 'manage_woocommerce',
            'wc_get_webhooks' => 'manage_woocommerce',
